class Simulation {
  ...
  constructor({ id, space }) {
    ...
    const displayTotalXSpan = topElement.querySelector(`.displayTotalX`);
    const displayTotalYSpan = topElement.querySelector(`.displayTotalY`);
    ...
    this.displayTotalXSpan = displayTotalXSpan;
    this.displayTotalYSpan = displayTotalYSpan;

    this.eventConfigChanged();
  }

  updateDisplay() {
    this.displayTotalXSpan.innerHTML = this.space.totalSpeedX();
    this.displayTotalYSpan.innerHTML = this.space.totalSpeedY();
  }
  ...
  eventConfigChanged() {
    ...
    // changed to setter: this.space.setDrawStarTail(drawStarTail);
    ...
    // changed to setter: this.space.setDrawStarsLine(drawStarsLine);
